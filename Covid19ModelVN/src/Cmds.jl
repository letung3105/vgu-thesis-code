...
"""
get_losses_figure_path(fdir::AbstractString, uuid::AbstractString) =
...
* `uuid::AbstractString`: the file unique identifier
"""
get_params_snapshot_path(fdir::AbstractString, uuid::AbstractString) =
