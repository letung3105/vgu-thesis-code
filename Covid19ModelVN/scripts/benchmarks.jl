...
benchmarks_compute_loss_gradient_with_different_sensealg(rmsle, Vern7())

benchmarks_compute_loss_gradient_with_different_sensealg(rmsle, Vern9())

benchmarks_compute_loss_gradient_with_different_sensealg(rmsle, Tsit5())
